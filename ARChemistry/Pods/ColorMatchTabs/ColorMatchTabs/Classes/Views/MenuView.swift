...
//    }
    ...
    func layoutTabs() {
        ...
        tabs.leftAnchor.constraint(equalTo: leftAnchor).isActive = true
        tabs.topAnchor.constraint(equalTo: topAnchor, constant: 64).isActive = true
//        tabs.topAnchor.constraint(equalTo: topAnchor).isActive = true
        tabs.rightAnchor.constraint(equalTo: rightAnchor).isActive = true
    ...
    func layoutScrollMenu() {
        ...
        scrollMenu.topAnchor.constraint(equalTo: tabs.bottomAnchor).isActive = true
